...
if(isset($_POST['available_type'])&& isset($_POST['available_id'])){
    ...
    $query = "UPDATE `room` SET `available` = $type  WHERE `room`.`r_id` = $id";
...
if(isset($_POST['delete'])){
    $id = $_POST['delete'];
    $query = "DELETE FROM `room` WHERE `room`.`r_id` = $id";
    mysqli_query($conn, $query);
}
        ...
        <div class="cards ">
            ...
            <?php 
                ...
                if(isset($_SESSION['mobile'])){
                    $oid =$_SESSION['mobile'];
                    $list_query = "SELECT * FROM `room` WHERE`o_id`= $oid  ORDER BY `r_id` DESC" ;
